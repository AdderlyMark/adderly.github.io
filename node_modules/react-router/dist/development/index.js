...
function ServerRouter({
  ...
  let routes = _chunkSZQUWNVJjs.createServerRoutes.call(void 0, 
    manifest.routes,
    routeModules,
    context.future,
    context.isSpaMode
  ...
  for (let match of context.staticHandlerContext.matches) {
    ...
    if (route && manifestRoute && _chunkSZQUWNVJjs.shouldHydrateRouteLoader.call(void 0, 
      routeId,
      route.clientLoader,
  ...
  let router = _chunk2JY4UAJAjs.createStaticRouter.call(void 0, routes, context.staticHandlerContext);
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    _chunkSZQUWNVJjs.FrameworkContext.Provider,
    {
      value: {
        manifest,
        routeModules,
    ...
    /* @__PURE__ */ React.createElement(_chunkSZQUWNVJjs.RemixErrorBoundary, { location: router.state.location }, /* @__PURE__ */ React.createElement(
      _chunk2JY4UAJAjs.StaticRouterProvider,
      {
        router,
    ...
    _chunkSZQUWNVJjs.StreamTransfer,
    {
      context,
      identifier: 0,
  ...
  return function RoutesTestStub({
    ...
    if (routerRef.current == null) {
      ...
      let patched = processRoutes(
        ...
        _chunkSZQUWNVJjs.convertRoutesToDataRoutes.call(void 0, routes, (r) => r),
        _context !== void 0 ? _context : _optionalChain([future, 'optionalAccess', _4 => _4.v8_middleware]) ? new (0, _chunkSZQUWNVJjs.RouterContextProvider)() : {},
        frameworkContextRef.current.manifest,
        frameworkContextRef.current.routeModules
      );
      routerRef.current = _chunkSZQUWNVJjs.createMemoryRouter.call(void 0, patched, {
        initialEntries,
        initialIndex,
        hydrationData
      });
    }
    return /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.FrameworkContext.Provider, { value: frameworkContextRef.current }, /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.RouterProvider, { router: routerRef.current }));
  };
}
function processRoutes(routes, context, manifest, routeModules, parentId) {
  return routes.map((route) => {
    ...
    let newRoute = {
      ...
      path: route.path,
      index: route.index,
      Component: route.Component ? _chunkSZQUWNVJjs.withComponentProps.call(void 0, route.Component) : void 0,
      HydrateFallback: route.HydrateFallback ? _chunkSZQUWNVJjs.withHydrateFallbackProps.call(void 0, route.HydrateFallback) : void 0,
      ErrorBoundary: route.ErrorBoundary ? _chunkSZQUWNVJjs.withErrorBoundaryProps.call(void 0, route.ErrorBoundary) : void 0,
    ...
    routeModules[route.id] = {
      default: newRoute.Component || _chunkSZQUWNVJjs.Outlet,
...
function warnOnceAboutExpiresCookie(name, expires) {
  _chunkSZQUWNVJjs.warnOnce.call(void 0, 
    !expires,
...
function matchServerRoutes(routes, pathname, basename) {
  let matches = _chunkSZQUWNVJjs.matchRoutes.call(void 0, 
    routes,
    pathname,
    basename
  );
...
async function callRouteHandler(handler, args) {
  ...
  if (_chunkSZQUWNVJjs.isDataWithResponseInit.call(void 0, result) && result.init && result.init.status && _chunkSZQUWNVJjs.isRedirectStatusCode.call(void 0, result.init.status)) {
    ...
    let commonRoute = {
      ...
      loader: route.module.loader ? async (args) => {
        ...
        if (preRenderedData != null) {
          ...
          let decoded = await _chunkSZQUWNVJjs.decodeViaTurboStream.call(void 0, stream, global);
          let data2 = decoded.value;
          if (data2 && _chunkSZQUWNVJjs.SingleFetchRedirectSymbol in data2) {
            let result = data2[_chunkSZQUWNVJjs.SingleFetchRedirectSymbol];
            let init = { status: result.status };
            if (result.reload) {
              throw _chunkSZQUWNVJjs.redirectDocument.call(void 0, result.redirect, init);
            } else if (result.replace) {
              throw _chunkSZQUWNVJjs.replace.call(void 0, result.redirect, init);
            } else {
              throw _chunkSZQUWNVJjs.redirect.call(void 0, result.redirect, init);
            }
          } else {
            invariant2(
...
function createServerHandoffString(serverHandoff) {
  return _chunkSZQUWNVJjs.escapeHtml.call(void 0, JSON.stringify(serverHandoff));
}
...
var SERVER_NO_BODY_STATUS_CODES = /* @__PURE__ */ new Set([
  ..._chunkSZQUWNVJjs.NO_BODY_STATUS_CODES,
  304
]);
async function singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
  ...
  function handleQueryResult(result) {
    return _chunkSZQUWNVJjs.isResponse.call(void 0, result) ? result : staticContextToResponse(result);
  }
  ...
  function staticContextToResponse(context) {
    ...
    if (_chunkSZQUWNVJjs.isRedirectStatusCode.call(void 0, context.statusCode) && headers.has("Location")) {
      return new Response(null, { status: context.statusCode, headers });
    }
    if (context.errors) {
      Object.values(context.errors).forEach((err) => {
        if (!_chunkSZQUWNVJjs.isRouteErrorResponse.call(void 0, err) || err.error) {
          handleError(err);
        }
      });
...
function generateSingleFetchRedirectResponse(redirectResponse, request, build, serverMode) {
  ...
  return generateSingleFetchResponse(request, build, serverMode, {
    result: request.method === "GET" ? { [_chunkSZQUWNVJjs.SingleFetchRedirectSymbol]: redirect2 } : redirect2,
    headers,
    status: _chunkSZQUWNVJjs.SINGLE_FETCH_REDIRECT_STATUS
  });
}
function getSingleFetchRedirect(status, headers, basename) {
  let redirect2 = headers.get("Location");
  if (basename) {
    redirect2 = _chunkSZQUWNVJjs.stripBasename.call(void 0, redirect2, basename) || redirect2;
  }
  return {
    redirect: redirect2,
    status,
...
function encodeViaTurboStream(data2, requestSignal, streamTimeout, serverMode) {
  ...
  return _chunkSZQUWNVJjs.encode.call(void 0, data2, {
    ...
    plugins: [
      (value) => {
        ...
        if (value instanceof _chunkSZQUWNVJjs.ErrorResponseImpl) {
          let { data: data3, status, statusText } = value;
          return ["ErrorResponse", data3, status, statusText];
        }
        if (value && typeof value === "object" && _chunkSZQUWNVJjs.SingleFetchRedirectSymbol in value) {
          return ["SingleFetchRedirect", value[_chunkSZQUWNVJjs.SingleFetchRedirectSymbol]];
        }
      }
    ],
    postPlugins: [
...
function derive(build, mode) {
  ...
  let staticHandler = _chunkSZQUWNVJjs.createStaticHandler.call(void 0, dataRoutes, {
  ...
  let errorHandler = build.entry.module.handleError || ((error, { request }) => {
    if (serverMode !== "test" /* Test */ && !request.signal.aborted) {
      console.error(
        ...
        _chunkSZQUWNVJjs.isRouteErrorResponse.call(void 0, error) && error.error ? error.error : error
      );
    }
  });
  let requestHandler = async (request, initialContext) => {
    ...
    if (build.future.v8_middleware) {
      if (initialContext && !(initialContext instanceof _chunkSZQUWNVJjs.RouterContextProvider)) {
        let error = new Error(
      ...
      loadContext = initialContext || new (0, _chunkSZQUWNVJjs.RouterContextProvider)();
    } else {
    ...
    if (_chunkSZQUWNVJjs.stripBasename.call(void 0, normalizedPath, normalizedBasename) === "/_root.data") {
      normalizedPath = normalizedBasename;
    } else if (normalizedPath.endsWith(".data")) {
      normalizedPath = normalizedPath.replace(/\.data$/, "");
    }
    if (_chunkSZQUWNVJjs.stripBasename.call(void 0, normalizedPath, normalizedBasename) !== "/" && normalizedPath.endsWith("/")) {
    ...
    if (!build.ssr) {
      ...
      if (normalizedBasename !== "/") {
        let strippedPath = _chunkSZQUWNVJjs.stripBasename.call(void 0, decodedPath, normalizedBasename);
        if (strippedPath == null) {
          errorHandler(
            new (0, _chunkSZQUWNVJjs.ErrorResponseImpl)(
              404,
              "Not Found",
    ...
    let manifestUrl = _chunkSZQUWNVJjs.getManifestPath.call(void 0, 
    ...
    if (url.pathname.endsWith(".data")) {
      ...
      if (_chunkSZQUWNVJjs.isRedirectResponse.call(void 0, response)) {
  ...
  if (build.entry.module.unstable_instrumentations) {
    requestHandler = _chunkSZQUWNVJjs.instrumentHandler.call(void 0, 
      requestHandler,
...
async function handleDocumentRequest(serverMode, build, staticHandler, request, loadContext, handleError, isSpaMode, criticalCss) {
  try {
    let result = await staticHandler.query(request, {
      ...
      generateMiddlewareResponse: build.future.v8_middleware ? async (query) => {
        try {
          ...
          if (!_chunkSZQUWNVJjs.isResponse.call(void 0, innerResult)) {
    ...
    if (!_chunkSZQUWNVJjs.isResponse.call(void 0, result)) {
  ...
  async function renderHtml(context, isSpaMode2) {
    ...
    try {
      ...
      if (_chunkSZQUWNVJjs.isResponse.call(void 0, error)) {
        try {
          let data2 = await unwrapResponse(error);
          errorForSecondRender = new (0, _chunkSZQUWNVJjs.ErrorResponseImpl)(
            error.status,
            error.statusText,
            data2
          );
      ...
      context = _chunkSZQUWNVJjs.getStaticContextFromError.call(void 0, 
...
async function routeRSCServerRequest({
  ...
  try {
    ...
    if (serverResponse.status === _chunkSZQUWNVJjs.SINGLE_FETCH_REDIRECT_STATUS && payload.type === "redirect") {
    ...
    let html = await renderHTML(getPayload, {
      onError(error) {
        if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
          renderRedirect = _chunkSZQUWNVJjs.decodeRedirectErrorDigest.call(void 0, error.digest);
          if (renderRedirect) {
            return error.digest;
          }
          let routeErrorResponse = _chunkSZQUWNVJjs.decodeRouteErrorResponseDigest.call(void 0, error.digest);
        ...
        if (renderRedirect) {
          controller.enqueue(
            new TextEncoder().encode(
              `<meta http-equiv="refresh" content="0;url=${_chunkSZQUWNVJjs.escapeHtml.call(void 0, renderRedirect.location)}"/>`
            )
          );
        }
      }
    ...
    try {
      ...
      let [status, statusText] = _chunkSZQUWNVJjs.isRouteErrorResponse.call(void 0, reason) ? [reason.status, reason.statusText] : [500, ""];
      let retryRedirect;
      let reactHeaders = new Headers();
      const html = await renderHTML(
        ...
        },
        {
          onError(error) {
            if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
              retryRedirect = _chunkSZQUWNVJjs.decodeRedirectErrorDigest.call(void 0, error.digest);
              if (retryRedirect) {
                return error.digest;
              }
              let routeErrorResponse = _chunkSZQUWNVJjs.decodeRouteErrorResponseDigest.call(void 0, 
                error.digest
              );
              if (routeErrorResponse) {
                status = routeErrorResponse.status;
      ...
      const retryRedirectTransform = new TransformStream({
        flush(controller) {
          if (retryRedirect) {
            controller.enqueue(
              new TextEncoder().encode(
                `<meta http-equiv="refresh" content="0;url=${_chunkSZQUWNVJjs.escapeHtml.call(void 0, retryRedirect.location)}"/>`
              )
            );
          }
        }
...
function RSCStaticRouter({ getPayload }) {
  ...
  const router = _chunk2JY4UAJAjs.createStaticRouter.call(void 0, 
  ...
  const frameworkContext = {
    ...
    routeDiscovery: { mode: "lazy", manifestPath: "/__manifest" },
    routeModules: _chunkGNDLROV6js.createRSCRouteModules.call(void 0, payload)
  };
